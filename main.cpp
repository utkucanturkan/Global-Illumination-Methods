...
int main(int argc, char** argv) {
    ...
    lights.push_back(Light(glm::dvec3(0, 10, 10), 1.0));
    lights.push_back(Light(glm::dvec3(30, 50, -25), 1.0));
    ...
    Sphere ivorySphere({-2, 3, -5}, 2, ivory);
    Sphere glassSphere({-3, 1, 0}, 2, glass);
    Sphere redRubberSphere({2, 1, 0}, 2, red_rubber);
    Sphere mirrorSphere({2, 4, -5}, 2, mirror);

    //Triangle* triangle =  new Triangle({0, 0, -10}, {1, 0, -10}, {1, 1, -10}, ivory);
